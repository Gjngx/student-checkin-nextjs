...
import ClassTable from '@/components/admin/aclasses/class.table'
...
function ClassList() {
    ...
    const { data, isLoading, mutate } = useSWR(`${CLASS_API_URL}?page=${pageIndex}&size=${ROWS_PER_PAGE}`, fetcher, {
        revalidateIfStale: false,
        revalidateOnFocus: false,
        revalidateOnReconnect: false
    })
    const { data: dataLength } = useSWR(`${CLASS_API_URL}`, fetcher, {
        revalidateIfStale: false,
        revalidateOnFocus: false,
        revalidateOnReconnect: false
    })
    ...
    const fuse = new Fuse(dataLength, {
        includeScore: true,
        keys: ['aclassID', 'teacherID', 'courseID', 'className', 'numberOfSessions'],
    });
