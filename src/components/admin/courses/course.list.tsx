...
function CourseList() {
    ...
    const { data, isLoading } = useSWR(`${COURSE_API_URL}?page=${pageIndex}&size=${ROWS_PER_PAGE}`, fetcher, {
        revalidateIfStale: false,
        revalidateOnFocus: false,
        revalidateOnReconnect: false
    })
    const { data: dataLength } = useSWR(`${COURSE_API_URL}`, fetcher, {
        revalidateIfStale: false,
        revalidateOnFocus: false,
        revalidateOnReconnect: false
    })
