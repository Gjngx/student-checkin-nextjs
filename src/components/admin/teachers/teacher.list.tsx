...
function TeacherList() {
    ...
    const { data, isLoading } = useSWR(`${TEACHERS_API_URL}?page=${pageIndex}&size=${ROWS_PER_PAGE}`, fetcher, {
        revalidateIfStale: false,
        revalidateOnFocus: false,
        revalidateOnReconnect: false
    })
    const { data: dataLength } = useSWR(`${TEACHERS_API_URL}`, fetcher, {
        revalidateIfStale: false,
        revalidateOnFocus: false,
        revalidateOnReconnect: false
    })
    ...
    const fuse = new Fuse(dataLength, {
        includeScore: true,
        keys: ['lastName', 'firstName', 'email', 'phoneNumber'],
    });
